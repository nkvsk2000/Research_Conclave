...
<body align="center" bgcolor="#ACEF84">
	...
	<button class="button1" onclick="signout()">Signout</button><br>
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" method="post">
		 <input class="button" type="submit" name="allocate" value="Allocate">
	</form><br>
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" method="post">
		 <input class="button" type="submit" name="allocated_list" value="See the List">
	</form><br>
	<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" method="post">
		 <input class="button" type="submit" name="addnotice" value="Add Notices">
	</form>
